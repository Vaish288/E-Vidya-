...
contract Edublocks {
    ...
    function studentLogin(string memory n, string memory p) public view returns (int256, bool) {
  require(!isEducator[msg.sender], "Cannot login as Student");
...
function educatorLogin(string memory n, string memory p) public view returns (int256, bool) {
  //bool found = false;
  ...
  return (-1, false);
    ...
    function submitAssignment(
        ...
        revert("Course ID not found for the given student");
    }
