  ...
  return (
    <div className="course-card">
      ...
      <div className="course-content">
        ...
        <p id="course-subs">
          Users:{" "}
          <Badge variant="info" className="text-colour">
            {subs || "0"}
          </Badge>
        </p>
        <p id="course-price">
          Price:{" "}
          <Badge variant="success" className="text-colour">
            {price || "No data"} EDBX
          </Badge>
        </p>
        <p id="course-author">
          Author:{" "}
          <Badge variant="secondary" className="text-colour">
            {author || "No data"}
          </Badge>
        </p>
        {!type ? (
          ...
          >
            {loading ? (
              <TailSpin type="TailSpin" height="25" width="25" color="#fff" />
            ) : (
              "Purchase"
            )}
          </Button>
